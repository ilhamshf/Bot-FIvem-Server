...
exports.start = function(SETUP) {
  ...
  const UpdateEmbed = function() {
    ...
    .setAuthor("iROLEPLAY Server Status", "https://cdn.discordapp.com/attachments/695793402578731079/817564488311504926/Chicken_Hunter_Squad-min.png")
    .setColor(0x2894C2)
    .setFooter(TICK_N % 2 === 0 ? '⚪ Ilham.shf' : '⚫ Ilham.shf')
    .setTimestamp(new Date())
    .addField('\n\u200b\nBagaimana Anda bisa bergabung dengan server?','Anda dapat bergabung dengan server dengan mendownload **Launcher** di website. Di bagian bawah adalah status server untuk melihat berapa banyak orang yang sedang online dan dalam antrian. Sistem ini dibuat oleh CFX.RE dan dimodifikasi oleh ilhmshf#8364\n\u200b\n',false)
    if (STATUS !== undefined)
    {
  ...
  bot.on('ready',() => {
    ...
    bot.user.setActivity('iROLEPLAY',{'url':'https://ilhamshf.my.id','type':'PLAYING'});
